...
<div id="container">
    ...
    <div id="content">
        ...
        <div id="content">
            ...
            $query = "Select Titre_Album, Code_Album from Album where Code_Album=" . $_GET['Code'];
            ...
            <div>
                ...
                $query = "select Enregistrement.Titre  from Album
              ...
              where Album.Code_Album=" . $_GET['Code'] . "group by Titre_Album, Enregistrement.Titre";
                foreach ($pdo->query($query) as $row) {
                    echo '<b>Nom</b> : ' . $row['Titre'] . "<br>";
                }
                $pdo = null;
                ?>
            </div>
